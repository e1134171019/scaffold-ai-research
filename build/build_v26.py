...
SITE_ASSETS = [
    ...
    "act4-v30.css",
    "act5-v31.css",
    "scheme1-devpath-v32.css",
    "narrative-v23.js",
    "feature-bridge-v24.js",
    "act3-v29.js",
    "act4-v30.js",
    "act5-v31.js",
    "scheme1-devpath-v32.js",
]

STYLE_MARKUP = (
    '<link rel="stylesheet" href="./narrative-v23.css?v=32">'
    '<link rel="stylesheet" href="./storyline-v26.css?v=32">'
    '<link rel="stylesheet" href="./feature-bridge-v24.css?v=32">'
    '<link rel="stylesheet" href="./act3-v29.css?v=32">'
    '<link rel="stylesheet" href="./act4-v30.css?v=32">'
    '<link rel="stylesheet" href="./act5-v31.css?v=32">'
    '<link rel="stylesheet" href="./scheme1-devpath-v32.css?v=32">'
...
SCRIPT_MARKUP = (
    '<script src="./narrative-v23.js?v=32"></script>'
    '<script src="./feature-bridge-v24.js?v=32"></script>'
    '<script src="./act3-v29.js?v=32"></script>'
    '<script src="./act4-v30.js?v=32"></script>'
    '<script src="./act5-v31.js?v=32"></script>'
    '<script src="./scheme1-devpath-v32.js?v=32"></script>'
)
